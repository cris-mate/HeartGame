...
public enum GameEventType {
    ...
    /**
     * Published when the game timer expires (countdown reaches zero)
     * Published by GameTimer when time runs out
     * Data: null (no data passed - GameController retrieves final score separately)
     */
    GAME_ENDED,
